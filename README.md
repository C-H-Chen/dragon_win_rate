...
這些打擊指標可以觀察到許多都與 "上壘" 直接相關，  
再加上 "OBP(上壘率)" 於F檢定中對勝率是最具影響力的特徵，故 "上壘" 可能會是影響勝率之最重要的因子之一。   

邊際效應分析可以發現 "ISO(純長打率)" 對勝率影響有顯著變化，"OBP" 則對勝率影響未有顯著變化，

但 "OPS" 和 "wOBA" 這兩個與 "OBP" 直接相關的特徵卻發生了顯著變化，
原因在於 "OPS" 和 "wOBA" 也和 "長打" 直接相關所致，

故 "長打" 也可能會是影響勝率之最重要的因子之一。   
